...
/*==================== SERVICES MODAL PARA APAREZCA Y DESAPAREZCA ====================*/
...
/*==================== PORTFOLIO SWIPER configuracion ====================*/
...
/*==================== SCROLL SECTIONS ACTIVE LINK para que el menu no desaparezca solo ====================*/
...
/*==================== CHANGE BACKGROUND HEADER para que no desaparezca la barra de app ====================*/ 
...
/*==================== SHOW SCROLL UP botton para que suba automatico la fecla del menu ====================*/ 
function scrollUp(){
...
/*=========Scroll titulos y subitkis =======*/ 
sr.reveal(".section__title",{})
sr.reveal(".section__subtitle",{delay:200})



/*=========cursor configuracion =======*/ 
